...
function barajear() {
    ...
    document.getElementById('C1').onclick=function(){
        ...
        if(document.getElementById('J1').value==1){
            document.getElementById("S1").src = "Img/1st-Level/I1.png";
            cartt.push(1);
            pos[intentos]=1;
       }else if(document.getElementById('J1').value==2){
            document.getElementById("S1").src = "Img/1st-Level/I2.png";
            cartt.push(2);
            pos[intentos]=1;
       }else if(document.getElementById('J1').value==3){
            document.getElementById("S1").src = "Img/1st-Level/I3.png";
            cartt.push(3);
            pos[intentos]=1;
       }else if(document.getElementById('J1').value==4){
            document.getElementById("S1").src = "Img/1st-Level/I4.png";
            cartt.push(4);
            pos[intentos]=1;
       }else{
            document.getElementById("S1").src = "Img/1st-Level/I5.png";
            cartt.push(5);
            pos[intentos]=1;
       }
       if(intentos==2){
    ...
    document.getElementById('C2').onclick=function(){
        ...
        if(document.getElementById('J2').value==1){
            document.getElementById("S2").src = "Img/1st-Level/I1.png";
            cartt.push(1);
            pos[intentos]=2;
       }else if(document.getElementById('J2').value==2){
            document.getElementById("S2").src = "Img/1st-Level/I2.png";
            cartt.push(2);
            pos[intentos]=2;
       }else if(document.getElementById('J2').value==3){
            document.getElementById("S2").src = "Img/1st-Level/I3.png";
            cartt.push(3);
            pos[intentos]=2;
       }else if(document.getElementById('J2').value==4){
            document.getElementById("S2").src = "Img/1st-Level/I4.png";
            cartt.push(4);
            pos[intentos]=2;
       }else{
            document.getElementById("S2").src = "Img/1st-Level/I5.png";
            cartt.push(5);
            pos[intentos]=2;
       }
       if(intentos==2){
    ...
    document.getElementById('C3').onclick=function(){
        ...
        if(document.getElementById('J3').value==1){
            document.getElementById("S3").src = "Img/1st-Level/I1.png";
            cartt.push(1);
            pos[intentos]=3;
       }else if(document.getElementById('J3').value==2){
            document.getElementById("S3").src = "Img/1st-Level/I2.png";
            cartt.push(2);
            pos[intentos]=3;
       }else if(document.getElementById('J3').value==3){
            document.getElementById("S3").src = "Img/1st-Level/I3.png";
            cartt.push(3);
            pos[intentos]=3;
       }else if(document.getElementById('J3').value==4){
            document.getElementById("S3").src = "Img/1st-Level/I4.png";
            cartt.push(4);
            pos[intentos]=3;
       }else{
            document.getElementById("S3").src = "Img/1st-Level/I5.png";
            cartt.push(5);
            pos[intentos]=3;
       }
       if(intentos==2){
    ...
    document.getElementById('C4').onclick=function(){
        ...
        if(document.getElementById('J4').value==1){
            document.getElementById("S4").src = "Img/1st-Level/I1.png";
            cartt.push(1);
            pos[intentos]=4;
        }else if(document.getElementById('J4').value==2){
            document.getElementById("S4").src = "Img/1st-Level/I2.png";
            cartt.push(2);
            pos[intentos]=4;
        }else if(document.getElementById('J4').value==3){
            document.getElementById("S4").src = "Img/1st-Level/I3.png";
            cartt.push(3);
            pos[intentos]=4;
        }else if(document.getElementById('J4').value==4){
            document.getElementById("S4").src = "Img/1st-Level/I4.png";
            cartt.push(4);
            pos[intentos]=4;
        }else{
            document.getElementById("S4").src = "Img/1st-Level/I5.png";
            cartt.push(5);
            pos[intentos]=4;
        }
        if(intentos==2){
    ...
    document.getElementById('C5').onclick=function(){
        ...
        if(document.getElementById('J5').value==1){
            document.getElementById("S5").src = "Img/1st-Level/I1.png";
            cartt.push(1);
            pos[intentos]=5;
        }else if(document.getElementById('J5').value==2){
            document.getElementById("S5").src = "Img/1st-Level/I2.png";
            cartt.push(2);
            pos[intentos]=5;
        }else if(document.getElementById('J5').value==3){
            document.getElementById("S5").src = "Img/1st-Level/I3.png";
            cartt.push(3);
            pos[intentos]=5;
        }else if(document.getElementById('J5').value==4){
            document.getElementById("S5").src = "Img/1st-Level/I4.png";
            cartt.push(4);
            pos[intentos]=5;
        }else{
            document.getElementById("S5").src = "Img/1st-Level/I5.png";
            cartt.push(5);
            pos[intentos]=5;
        }
        if(intentos==2){
    ...
    document.getElementById('C6').onclick=function(){
        ...
        if(document.getElementById('J6').value==1){
            document.getElementById("S6").src = "Img/1st-Level/I1.png";
            cartt.push(1);
            pos[intentos]=6;
        }else if(document.getElementById('J6').value==2){
            document.getElementById("S6").src = "Img/1st-Level/I2.png";
            cartt.push(2);
            pos[intentos]=6;
        }else if(document.getElementById('J6').value==3){
            document.getElementById("S6").src = "Img/1st-Level/I3.png";
            cartt.push(3);
            pos[intentos]=6;
        }else if(document.getElementById('J6').value==4){
            document.getElementById("S6").src = "Img/1st-Level/I4.png";
            cartt.push(4);
            pos[intentos]=6;
        }else{
            document.getElementById("S6").src = "Img/1st-Level/I5.png";
            cartt.push(5);
            pos[intentos]=6;
        }
        if(intentos==2){
    ...
    document.getElementById('C7').onclick=function(){
        ...
        if(document.getElementById('J7').value==1){
            document.getElementById("S7").src = "Img/1st-Level/I1.png";
            cartt.push(1);
            pos[intentos]=7;
       }else if(document.getElementById('J7').value==2){
            document.getElementById("S7").src = "Img/1st-Level/I2.png";
            cartt.push(2);
            pos[intentos]=7;
       }else if(document.getElementById('J7').value==3){
            document.getElementById("S7").src = "Img/1st-Level/I3.png";
            cartt.push(3);
            pos[intentos]=7;
       }else if(document.getElementById('J7').value==4){
            document.getElementById("S7").src = "Img/1st-Level/I4.png";
            cartt.push(4);
            pos[intentos]=7;
       }else{
            document.getElementById("S7").src = "Img/1st-Level/I5.png";
            cartt.push(5);
            pos[intentos]=7;
       }
       if(intentos==2){
    ...
    document.getElementById('C8').onclick=function(){
        ...
        if(document.getElementById('J8').value==1){
            document.getElementById("S8").src = "Img/1st-Level/I1.png";
            cartt.push(1);
            pos[intentos]=8;
        }else if(document.getElementById('J8').value==2){
            document.getElementById("S8").src = "Img/1st-Level/I2.png";
            cartt.push(2);
            pos[intentos]=8;
        }else if(document.getElementById('J8').value==3){
            document.getElementById("S8").src = "Img/1st-Level/I3.png";
            cartt.push(3);
            pos[intentos]=8;
        }else if(document.getElementById('J8').value==4){
            document.getElementById("S8").src = "Img/1st-Level/I4.png";
            cartt.push(4);
            pos[intentos]=8;
        }else{
            document.getElementById("S8").src = "Img/1st-Level/I5.png";
            cartt.push(5);
            pos[intentos]=8;
        }
       if(intentos==2){
    ...
    document.getElementById('C9').onclick=function(){
        ...
        if(document.getElementById('J9').value==1){
            document.getElementById("S9").src = "Img/1st-Level/I1.png";
            cartt.push(1);
            pos[intentos]=9;
        }else if(document.getElementById('J9').value==2){
            document.getElementById("S9").src = "Img/1st-Level/I2.png";
            cartt.push(2);
            pos[intentos]=9;
       }else if(document.getElementById('J9').value==3){
            document.getElementById("S9").src = "Img/1st-Level/I3.png";
            cartt.push(3);
            pos[intentos]=9;
       }else if(document.getElementById('J9').value==4){
            document.getElementById("S9").src = "Img/1st-Level/I4.png";
            cartt.push(4);
            pos[intentos]=9;
       }else{
            document.getElementById("S9").src = "Img/1st-Level/I5.png";
            cartt.push(5);
            pos[intentos]=9;
       }
       if(intentos==2){
    ...
    document.getElementById('C10').onclick=function(){
        ...
        if(document.getElementById('J10').value==1){
            document.getElementById("S10").src = "Img/1st-Level/I1.png";
            cartt.push(1);
            pos[intentos]=10;
        }else if(document.getElementById('J10').value==2){
            document.getElementById("S10").src = "Img/1st-Level/I2.png";
            cartt.push(2);
            pos[intentos]=10;
        }else if(document.getElementById('J10').value==3){
            document.getElementById("S10").src = "Img/1st-Level/I3.png";
            cartt.push(3);
            pos[intentos]=10;
        }else if(document.getElementById('J10').value==4){
            document.getElementById("S10").src = "Img/1st-Level/I4.png";
            cartt.push(4);
            pos[intentos]=10;
        }else{
            document.getElementById("S10").src = "Img/1st-Level/I5.png";
            cartt.push(5);
            pos[intentos]=10;
        }
        if(intentos==2){
        ...
        for(var i = 1; i <=10 ; i++){
            for(var j =0;j<wins.length;j++){
                if(document.getElementById('J'+i).value==wins[j]){
                    document.getElementById("S"+i).src = "Img/1st-Level/I"+wins[j]+".png";
                }
            }
        }
    }else{
...
function animo() {
    $('[data-toggle="tooltip"]').tooltip({
        ...
        html: true,
        trigger: 'manual',
        title: '<div class="container-fluid" id="Cont"><div class="row form-group"><div class="col-12 col-md-12"><img src="Img/CheerUp.png" id="CU" class="img-fluid"></div></div></div>'
    });
